...
namespace hpp {
  namespace core {
      ...
      distanceBetweenObjects_ ()
    {
      ...
      add <DistanceBuilder_t> ("WeighedDistance", WeighedDistance::createFromProblem);
      add <DistanceBuilder_t> ("KinodynamicDistance",KinodynamicDistance::createFromProblem);
