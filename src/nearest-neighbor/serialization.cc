...
inline void NearestNeighbor::serialize(Archive& ar, const unsigned int version)
{
  (void) version;
  (void) ar;
}
...
{
  (void) version;
  ar & boost::serialization::make_nvp("base", boost::serialization::base_object<NearestNeighbor>(*this));
